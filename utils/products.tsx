export const products = [
  ...
  },
  {
    ...
    name: "Acer SWIFT SF314-57-38N7 Pink",
    description:
      "Acer Swift 3 SF314-57-38N7 โน๊ตบุ๊คบางเบา สีชมพู ดูดีมีสไตล์ พกไปนอกสถานที่พร้อมความมั่นใจ หน้าจอ IPS Full HD 14 นิ้ว ให้ภาพคมชัด สีสันสวย สเปคคุณภาพสำหรับการใช้งานทั่วไป ด้วย CPU Intel Core i3-1005G1 มีการ์ดจอออนบอร์ด และ RAM 4 GB โดย Acer Swift 3 SF314-57-38N7 ใช้ SSD M.2 NVMe 256 GB เก็บข้อมูล พร้อมเพิ่มความเร็วในการใช้งานแบบองค์รวม ติดตั้ง Windows 10 ลิขสิทธิ์แท้ มีประกัน 2 ปี ฟรีค่าแรง ค่าอะไหล่.",
    price: 16990,
    brand: "Acer",
    category: "NoteBook",
    inStock: true,
    images: [
      {
        ...
        colorCode: "#000000",
        image:
          "https://media-cdn.bnn.in.th/16995/Acer-Notebook-SWIFT-SF314-57-38N7-Pink-1-square_medium.jpg",
      },
      {
        color: "Blue",
        colorCode: " #0000FF",
